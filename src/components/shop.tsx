...
export default function Shop() {
    ...
    const { total, isLoading, dataProduct,search, token }: { total: Total; isLoading: boolean; dataProduct: any,search:string } = useSelector((state: any) => ({
        ...
        <>
            <div className="container">
                ...
                <div className="body-container">
                    {selectedProd == null && <div className="body-container-silder">
